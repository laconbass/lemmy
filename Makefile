...
create-html5-app-layout:
	...
	@mv $(TEMPORARY_DIRECTORY)/$(SCRIPTS_DIRECTORY)/main.js $(PUBLIC_DIRECTORY)/$(SCRIPTS_DIRECTORY)
	@mv $(TEMPORARY_DIRECTORY)/$(SCRIPTS_DIRECTORY)/plugins.js $(PUBLIC_DIRECTORY)/$(SCRIPTS_DIRECTORY)
	@mv $(TEMPORARY_DIRECTORY)/$(SCRIPTS_DIRECTORY)/vendor/jquery-*.min.js $(PUBLIC_DIRECTORY)/$(SCRIPTS_DIRECTORY)/jquery.js
	@mv $(TEMPORARY_DIRECTORY)/$(SCRIPTS_DIRECTORY)/vendor/modernizr-*.min.js $(PUBLIC_DIRECTORY)/$(SCRIPTS_DIRECTORY)/modernizr.js
	@rm -rf $(TEMPORARY_DIRECTORY)
...
create-html5-subapp-layout:
	...
	then \
		...
		mv $(TEMPORARY_DIRECTORY)/$(SCRIPTS_DIRECTORY)/main.js $(PUBLIC_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(SCRIPTS_DIRECTORY); \
