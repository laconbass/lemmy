...
create-html5-app-layout:
	...
	@mv $(TEMPORARY_1140_DIRECTORY)/$(STYLES_DIRECTORY)/style.css $(PUBLIC_DIRECTORY)/$(STYLES_DIRECTORY)/app.css
...
create-html5-subapp-layout:
	...
	then \
		...
		mv $(TEMPORARY_1140_DIRECTORY)/$(STYLES_DIRECTORY)/style.css $(PUBLIC_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(STYLES_DIRECTORY)/app.css; \
