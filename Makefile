...
ifeq "$(APP_LANGUAGE)" "CS"
module:
	@mkdir -p $(SOURCE_DIRECTORY)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(MODULE_CS) > $(SOURCE_DIRECTORY)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).coffee
	@mkdir -p $(TESTING_DIRECTORY)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(TESTMODULE_CS) > $(TESTING_DIRECTORY)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.coffee
else
module:
	@mkdir -p $(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(MODULE_JS) > $(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).js
	@mkdir -p $(TESTING_DIRECTORY)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(TESTMODULE_JS) > $(TESTING_DIRECTORY)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.js
endif
endif
else
ifeq "$(GROUP)" ""
...
module:
	@if [ -d "$(SOURCE_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)" ]; \
	then \
		mkdir -p $(SOURCE_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(MODULE_CS) > $(SOURCE_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).coffee; \
		mkdir -p $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(TESTMODULE_CS) > $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.coffee; \
	else \
		echo "ERROR: You're required to give an existing APP argument to the 'module' task to create a new module inside your application."; \
	fi
else
module:
	@if [ -d "$(APPS_DIRECTORY)/$(APP_CAMELIZED)" ]; \
	then \
		mkdir -p $(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(MODULE_JS) > $(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).js; \
		mkdir -p $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(TESTMODULE_JS) > $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(MODULES_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.js; \
	else \
		echo "ERROR: You're required to give an existing APP argument to the 'module' task to create a new module inside your application."; \
	fi
endif
...
ifeq "$(APP_LANGUAGE)" "CS"
helper:
	@mkdir -p $(SOURCE_DIRECTORY)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(HELPER_CS) > $(SOURCE_DIRECTORY)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).coffee
	@mkdir -p $(TESTING_DIRECTORY)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(TESTHELPER_CS) > $(TESTING_DIRECTORY)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.coffee
else
helper:
	@mkdir -p $(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(HELPER_JS) > $(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).js
	@mkdir -p $(TESTING_DIRECTORY)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)
	@echo $(TESTHELPER_JS) > $(TESTING_DIRECTORY)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.js
endif
endif
else
ifeq "$(GROUP)" ""
...
helper:
	@if [ -d "$(SOURCE_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)" ]; \
	then \
		mkdir -p $(SOURCE_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(HELPER_CS) > $(SOURCE_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).coffee; \
		mkdir -p $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(TESTHELPER_CS) > $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.coffee; \
	else \
		echo "ERROR: You're required to give an existing APP argument to the 'helper' task to create a new helper inside your application."; \
	fi
else
helper:
	@if [ -d "$(APPS_DIRECTORY)/$(APP_CAMELIZED)" ]; \
	then \
		mkdir -p $(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(HELPER_JS) > $(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED).js; \
		mkdir -p $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED); \
		echo $(TESTHELPER_JS) > $(TESTING_DIRECTORY)/$(APPS_DIRECTORY)/$(APP_CAMELIZED)/$(HELPERS_DIRECTORY)/$(GROUP_CAMELIZED)/$(NAME_CAMELIZED)-test.js; \
	else \
		echo "ERROR: You're required to give an existing APP argument to the 'helper' task to create a new helper inside your application."; \
	fi
endif
